...
> 问题描述：小W发明了一个游戏，他在黑板上写出了一行数字a1,a2,a3,……,an，且已知序列b1,b2,b3,……,bn
然后给你M个回合的机会，每回合你可以从中选择一个数字擦去它，接着剩下来的每个数字ai都要递减一个值bi,即a1减掉b1,a2减掉b2,….。
如此重复M个回合，所有你擦去的数字之和就是你所得的分数。
> 
> 具体解答过程：https://starry-hu.github.io/2019/06/13/numberGameGreedy/

### demo13（小船过河）

> 有若干人需要过河，只有一条船，每个人划船的耗时不同，每次两个人划船，耗时为两人中较长的一个的，划船过去后需要人划船回来，问如何设计让所有人过河且耗时最短？
> 
> 具体解答过程：https://starry-hu.github.io/2019/06/13/shipAcrossRiver/

## 回溯法

### demo14（火柴棍摆正方形）

> 已知一个数组，保存了n个(n<=15)火柴棍，其长度为1、2、3、4不等，问可否使用这n个火柴棍摆成1个正方形?
> 
> 具体解答过程：https://starry-hu.github.io/2019/06/14/makeSquare/
